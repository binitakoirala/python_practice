#
# Write a function send_email(to, subject="No Subject") that sends an email. 
# For this challenge, simply return a formatted string stating the email was sent.
